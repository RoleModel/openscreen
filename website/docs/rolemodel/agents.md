...
The decision now lives in one place, [`lib/agents.mjs`](https://github.com/RoleModel/rolemodel-openscreen/blob/main/lib/agents.mjs), and
...
[`lib/jobs.mjs`](https://github.com/RoleModel/rolemodel-openscreen/blob/main/lib/jobs.mjs). That allowlist is the thing standing between a
